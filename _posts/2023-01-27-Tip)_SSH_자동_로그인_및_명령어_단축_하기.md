...
tag: [Others, Tip, Ubuntu, ssh, alias, Server]
toc: false
comments: true
math: true
mermaid: false
# img_path: /img/path/
pin: false
title: Tip) SSH Key 로그인과 alias를 사용하여 SSH 접속 명령어 단축하기
---
...
[공개키 암호 알고리즘](https://ko.wikipedia.org/wiki/%EA%B3%B5%EA%B0%9C_%ED%82%A4_%EC%95%94%ED%98%B8_%EB%B0%A9%EC%8B%9D)
