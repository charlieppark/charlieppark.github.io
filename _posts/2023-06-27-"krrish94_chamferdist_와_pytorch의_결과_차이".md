...
![[chamfer_distance]()](/images/2023-06-27/cham.png)

그런데, 때때로 이 chamfer distance는 전체 point의 개수에 의해 normalize 되기도 한다.

이때는 아래의 수식처럼 표현된다.

![[normalized_chamfer_distance]()](/images/2023-06-27/normcham.png)
...
![[PR](https://github.com/krrish94/chamferdist/pull/19)](/images/2023-06-27/pr.png)
